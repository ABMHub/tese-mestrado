...
\bottomrule
\end{tabular}
\caption{Average performance over each possible output dimension, considering the Euclidean distance, the Cosine distance, and considering both distances.}
...
\red{ANALISAR RESUTLADOS QUANDO ELES EXISTIREM}

The remaining of the experiments in this work are done with the best configuration of each architecture.
