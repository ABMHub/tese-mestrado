...
In such a scenario, organizations require document understanding pipeline to validate document types and extract data for business decision-making (see \refFig{fig:compliance}). 
